...
import 'package:kmunity_se/Screens/admin_Screen/bottomnav_admin.dart';
import 'package:kmunity_se/Screens/bottom_nav.dart';
import "package:google_fonts/google_fonts.dart";
import 'package:shared_preferences/shared_preferences.dart';

class plantsbook extends StatefulWidget {
  const plantsbook({super.key});

  @override
  State<plantsbook> createState() => _plantsbookState();
}

class _plantsbookState extends State<plantsbook> {
...
User? user = FirebaseAuth.instance.currentUser;
  ...
  Future<void> _fetchData() async {
    QuerySnapshot snapshot = await _firestore.collection('plantsbook').get();
    setState(() {
    ...
    AwesomeDialog(
            ...
            btnCancelOnPress: () async {
              ...
              if (role != null) {
                ...
                // Handle if role is not found in SharedPreferences
              }
            },
