...
class astronomybook extends StatefulWidget {
  const astronomybook({super.key});

  @override
  State<astronomybook> createState() => _astronomybookState();
}
...
class _astronomybookState extends State<astronomybook> {
  ...
  Widget build(BuildContext context) {
    ...
    String collection1 = "astronomybook";
    return Scaffold(
      body: Container(
